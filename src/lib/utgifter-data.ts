...
export const DEFAULT_CATEGORIES: ExpenseCategory[] = [
  ...
  },
  {
    ...
    icon: "Package",
    items: [
      { id: "klær", label: "Klær og sko", amount: 0 },
      { id: "elektronikk", label: "Elektronikk", amount: 0 },
      { id: "hårklipp", label: "Hårklipp / personlig stell", amount: 0 },
      { id: "medisiner", label: "Medisiner / apotek", amount: 0 },
    ],
  },
  {
    id: "barn",
